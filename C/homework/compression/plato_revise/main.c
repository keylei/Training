...
#include <stdlib.h> //rime 不同类型的头文件需要空出一行
...
int main()
{
    //rime 对于数据类型已经不需要加float了
    float *pFloatData;                               // 存放生成的数据的头指针

    //rime 数组数量是放在main中更加合适, 对于数据生成主要关心数据生成的算法, 对于具体生成多大规模的数据应该是上层高数他的
    short arrLenArr[ARR_COUNT];                      // 存放随机生成的数组长度  //rime 直接使用lenArr就可以了
