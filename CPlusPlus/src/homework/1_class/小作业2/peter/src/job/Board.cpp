...
Board::Board(double xPos, double yPos, double sizeX, double sizeY)
{
    try
    {

    }
    CATCH_AND_RETHROW_EXCEPTION("Constructor Board error!");
}
...
Board::~Board()
{
    try
    {
        ...
        if(!temp.empty())
        {
            THROW_EXCEPTION("Delete vector error!");
        }
    }
    CATCH_AND_RETHROW_EXCEPTION("Destructor Board error!");
}
//<<<----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
void Board::writeToXml(QString path)
{
    try
    {
        ...
        board.setAttribute("x原点",QString::number(this->m_xPos));
        board.setAttribute("y原点",QString::number(this->m_yPos));
