...
//        MeasuredObj * pMeasuredObj(){return this->m_pMeasuredObj;}
//        void setMeasuredOjPtr(MeasuredObj * pMeasuredObj){this->m_pMeasuredObj = pMeasuredObj;}
...
//        MeasuredObj * m_pMeasuredObj{nullptr};
//    };
